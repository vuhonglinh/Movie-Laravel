    ...
    public function data()
    {
        ...
        return DataTables::of($movies)
            ...
            ->editColumn('comments', function ($movie) {
                return '<a href="' . route('admin.comments.index', $movie->id) . '" class="main__table-btn main__table-btn--view open-modal">
            ...
            ->rawColumns(['comments','number', 'thumbnail', 'is_series', 'country_id', 'genre_id', 'category_id', 'edit', 'delete', 'created_at'])
            ->toJson();
    }
    public function add()
    {
