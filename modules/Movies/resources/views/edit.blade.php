                        ...
                        <div class="row">
                            <div class="col-12 col-md-5 form__cover">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-12">
                                        <div class="form__img">
                                            <div id="holder">
                                                <img src="{{ old('thumbnail') ?? $movie->thumbnail }}" alt="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="form__group">
                                                    <input type="text"
                                                        value="{{ old('thumbnail') ?? $movie->thumbnail }}" id="thumbnail"
                            ...
                            <div class="col-12 col-md-7 form__content">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form__group">
                                            <input type="text" value="{{ old('name') ?? $movie->name }}" name="name"
                                    ...
                                    <div class="col-12">
                                        <div class="form__group">
                                            <input type="text" value="{{ old('slug') ?? $movie->slug }}" name="slug"
                                    ...
                                    <div class="col-12">
                                        <div class="form__group">
                                            ...
                                            <textarea id="editor" name="description" class="editor form__textarea" placeholder="Description">{{ old('description') ?? $movie->description }}</textarea>
                                            @error('description')
                                                <span style="color: red">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form__group">
                                    <input type="date" value="{{ old('release_date') ?? $movie->release_date }}"
                                        name="release_date" class="form__input" placeholder="Release year">
                                    @error('release_date')
                                        <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form__group">
                                    <input type="text" value="{{ old('directors') ?? $movie->directors }}"
                                        name="directors" class="form__input" placeholder="Tên đạo diễn">
                                    @error('directors')
                                        <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form__group">
                                    <select class="js-example-basic-multiple" name="country_id[]" id="country"
                                        ...
                                        @foreach ($countries as $item)
                                            <option
                                                {{ in_array($item->id, old('country_id') ?? $countryIds) ? 'selected' : false }}
                                                {{ old('country_id') == $item->id ? 'selected' : false }}
                                ...
                                <div class="form__group">
                                    <select class="js-example-basic-multiple" name="category_id[]" id="category"
                                        ...
                                        @foreach ($categories as $item)
                                            <option
                                                {{ in_array($item->id, old('category_id') ?? $categoryIds) ? 'selected' : false }}
                                                value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                ...
                                <div class="form__group">
                                    <select class="js-example-basic-single" name="genre_id[]" id="genre"
                                        ...
                                        @foreach ($genres as $item)
                                            <option
                                                {{ in_array($item->id, old('genre_id') ?? $genreIds) ? 'selected' : false }}
                                                value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('genre_id')
                                ...
                                <ul class="form__radio">
                                    ...
                                    <li>
                                        <input id="HD" value="HD" type="radio"
                                            {{ old('quality') ?? $movie->quality == 'HD' ? 'checked' : false }}
                                            name="quality">
                                        <label for="HD">HD</label>
                                    </li>
                                    <li>
                                        <input id="SD" value="SD" type="radio"
                                            {{ old('quality') ?? $movie->quality == 'SD' ? 'checked' : false }}
                                            name="quality">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class="form__group">
                                        <input value="{{ old('trailer_url') ?? $movie->trailer_url }}" type="text"
                                            id="trailer" name="trailer_url" class="title form__input"
                            ...
                            <div class="row" id="movie">
                                <div class="col-10">
                                    <div class="form__group">
                                        <input type="text" value="{{ old('movie_url') ?? $movie->movie_url }}"
                                            id="videos" name="movie_url" class="title form__input"
