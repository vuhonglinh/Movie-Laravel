                    ...
                    <div class="sign__content">
                        ...
                        <form action="" method="POST" class="sign__form">
                            ...
                            <div class="sign__group">
                                <input type="text" name="name" value="{{ old('name') }}" class="sign__input"
                            ...
                            <div class="sign__group">
                                <input type="text" name="email" value="{{ old('email') }}" class="sign__input"
                                    placeholder="Email">
                                @error('email')
                                    <span style="color: red">{{ $message }}</span>
                                @enderror
                            ...
                            <span class="sign__text">Bạn có sắn tài khoản? <a href="{{ route('xacthuc.login') }}">Đăng
                                    nhập!</a></span>
                        </form>
                        <!-- registration form -->
                    </div>
