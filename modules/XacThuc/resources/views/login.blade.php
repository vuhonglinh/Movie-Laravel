                    ...
                    <div class="sign__content">
                        <form action="" method="POST" class="sign__form">
                            ...
                            <div class="sign__group">
                                <input type="text" value="{{ old('email') }}" autocomplete="email" autofocus
                                    class="sign__input" name="email" placeholder="Email">
                                @error('email')
                            ...
                            <div class="sign__social">
                                <a class="fb" href="{{ route('facebook') }}"><svg viewBox="0 0 9 17" fill="none"
                                ...
                                <a class="gl" href="{{ route('google') }}"><svg xmlns='http://www.w3.org/2000/svg' class='ionicon'
                                        viewBox='0 0 512 512'>
                                        <path
                            ...
                            <span class="sign__text">Bạn chưa có tài khoản? <a href="{{ route('xacthuc.register') }}">Đăng
                                    ký!</a></span>

                            <span class="sign__text"><a href="{{ route('xacthuc.forgot') }}">Quên mật khẩu?</a></span>
                        </form>
