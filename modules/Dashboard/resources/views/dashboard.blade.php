                    ...
                    <div class="dashbox">
                        <div class="dashbox__title">
                            <h3><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                </svg> Phim được đánh giá cao</h3>
                            <div class="dashbox__wrap">
                                <a class="dashbox__more" href="{{ route('admin.movies.index') }}">Hiển thị tất cả</a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text"><a
                                                        href="{{ route('admin.movies.edit', $item->id) }}">{{ $item->name }}</a>
                                                </div>
                                            </td>
                                            <td>
                    ...
                    <div class="dashbox">
                        ...
                        <div class="dashbox__table-wrap dashbox__table-wrap--2">
                            <table class="main__table main__table--dash">
                                ...
                                <tbody>
                                    @foreach ($getTopViewMovies as $item)
                                        <tr>
                                            <td>
                                                <div class="main__table-text">{{ $item->id }}</div>
                                            </td>
                    ...
                    <div class="dashbox">
                        <div class="dashbox__title">
                            <h3><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                </svg> Khách hàng mới</h3>

                            <div class="dashbox__wrap">
                                <a class="dashbox__more" href="{{route('admin.customers.index')}}">View All</a>
                            </div>
                        </div>
                        ...
                        <div class="dashbox__table-wrap dashbox__table-wrap--3">
                            <table class="main__table main__table--dash">
                                ...
                                <tbody>
                                    @foreach ($getNewCustomers as $item)
                                        <tr>
                                            <td>
                                                <div class="main__table-text">{{ $item->id }}</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text"><a
                                                        href="{{ route('admin.customers.edit', $item->id) }}">{{ $item->name }}</a>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="main__table-text main__table-text--grey">{{ $item->email }}
                                                </div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">{{ $item->address }}</div>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
