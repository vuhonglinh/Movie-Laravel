                    ...
                    <form action="" method="POST" class="form">
                        ...
                        <div class="col-12 col-md-7 form__content">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form__group">
                                        <select class="js-example-basic-multiple" name="number" id="number">
                                            @for ($i = 1; $i <= max($episodes) + 1; $i++)
                                                <option {{ in_array($i, $episodes) ? 'disabled' : false }}
                                                    value="{{ $i }}">
                                                    {{ $i }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form__group">
                                        <input type="text" value="{{ old('movie_url') }}" name="movie_url"
                                            class="form__input" placeholder="Đường dẫn phim...">
                                        @error('movie_url')
                                            <span style="color: red">{{ $message }}</span>
                                        @enderror
                                    </div>
